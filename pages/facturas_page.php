                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th style="text-align:center"><a href="../update/update_factura.php?id_factura=<?php echo $row['id_factura'] ?>"> <button type="button" class="btn btn-info"><i class="fa-solid fa-pencil"></i></button></a></th>
                                    ...
                                    <th style="text-align:center"><a href="facturas_page.php?id_factura=<?php echo $row['id_factura'] ?>&nombre=<?php echo $row['nombre'] ?>&fecha=<?php echo $row['fecha'] ?>"> <button type="button" class="btn btn-light"><i class="fa-solid fa-arrow-up-from-bracket"></i></button></a></th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th style="text-align:center"><a href="../update/update_detalles.php?id_detalle=<?php echo $row['id_detalles']?>&nombre=<?php echo $_GET['nombre']?>&fecha=<?php echo $_GET['fecha']?>&id_factura=<?php echo $_GET['id_factura']?>"> <button type="button" class="btn btn-info"><i class="fa-solid fa-pencil"></i></button></a></th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th style="text-align:center"><a href="../update/update_pago.php?id_pago=<?php echo $row['id_pagos']?>&nombre=<?php echo $_GET['nombre']?>&fecha=<?php echo $_GET['fecha']?>&id_factura=<?php echo $_GET['id_factura']?>"> <button type="button" class="btn btn-info"><i class="fa-solid fa-pencil"></i></button></a></th>
